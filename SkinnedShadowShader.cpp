...
D3D12_SHADER_BYTECODE SkinnedShadowShader::CreateVertexShader(ID3DBlob** shader_blob)
{
    return CompileShaderFromFile(L"Shadow.hlsl", "SkinnedMeshVS", "vs_5_1", shader_blob);
}

D3D12_SHADER_BYTECODE SkinnedShadowShader::CreatePixelShader(ID3DBlob** shader_blob)
{

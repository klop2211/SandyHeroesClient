...
D3D12_INPUT_LAYOUT_DESC TransparentShader::CreateInputLayout()
{
...
D3D12_SHADER_BYTECODE TransparentShader::CreateVertexShader(ID3DBlob** shader_blob)
{
    return CompileShaderFromFile(L"Transparent.hlsl", "VS", "vs_5_1", shader_blob);
}

D3D12_SHADER_BYTECODE TransparentShader::CreatePixelShader(ID3DBlob** shader_blob)
{
    return CompileShaderFromFile(L"Transparent.hlsl", "PS", "ps_5_1", shader_blob);
}

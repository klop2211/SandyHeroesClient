...
void BaseScene::BuildMesh(ID3D12Device* device, ID3D12GraphicsCommandList* command_list)
{
	...
	//debug mesh
	material = materials_[0].get(); // ?òÎ? ?ÜÎäî ?ÑÎ¨¥ Î®∏ÌÑ∞Î¶¨Ïñº
...
{
	//TODO: Í∞?Î©îÏâ¨??Ïª¥Ìè¨?åÌä∏ ?∞Í≤∞ Í∞úÏàòÎ•??åÏïÖ?òÎ©¥ ?ÑÎûò ?òÏπòÎ•??îÌÖå?ºÌïòÍ≤??§Ï†ï?????àÏùÑÍ≤?Í∞ôÎã§..
	...
	camera_object->set_position_vector(0, 0.4f, 0); // ÔøΩ√∑ÔøΩÔøΩÃæÔøΩ ƒ≥ÔøΩÔøΩÔøΩÔøΩÔøΩÔøΩ ≈∞ÔøΩÔøΩ 150ÔøΩŒ∞ÔøΩÔøΩÔøΩ ÔøΩÔøΩÔøΩÔøΩÔøΩœøÔøΩ ÔøΩ”∏ÔøΩÔøΩÔøΩƒ°ÔøΩÔøΩ ÔøΩÔøΩƒ°
	...
	//ÔøΩÔøΩÔøΩÔøΩÔøΩÔøΩÔøΩÔøΩ ƒ´ÔøΩﬁ∂ÔøΩ
	...
	//Î™®Îì† Î©îÏâ¨ ?àÎäî Í∞ùÏ≤¥??Î©îÏâ¨ ÏΩúÎùº?¥Îçî Ï∂îÍ?(Ï£ºÏùò?¨Ìï≠: ?àÎ°≠Í≤?ÎßåÎì§?¥Ï???Î©îÏâ¨?àÎäî Í∞ùÏ≤¥??Î©îÏâ¨ÏΩúÎùº?¥ÎçîÍ∞Ä ?ÜÏùå)
	//+ ?îÎ≤ÑÍ∑∏Ïö© Î©îÏâ¨ Ï∂îÍ?
...
void BaseScene::Render(ID3D12GraphicsCommandList* command_list)
{
	...
	//TODO: Ï°∞Î™Ö Í¥Ä???¥Îûò?§Î? ?ùÏÑ±??Í∑∏Í≤É???¨Ïö©?òÏó¨ ?ÑÎûò ?ïÎ≥¥ ?ÖÎç∞?¥Ìä∏(?ÑÏû¨???åÏä§?∏Ïö© ?òÎìúÏΩîÎî©)
	...
	//25.02.23 ?òÏ†ï
	//Í∏∞Ï°¥ Î£®Ìä∏ ?îÏä§?¨Î¶Ω???åÏù¥Î∏îÏóê??Î£®Ìä∏ CBVÎ°?Î≥ÄÍ≤?
	...
	// ?®Ïàú??Î∞∞Ïπò Ï≤òÎ¶¨ 
	// ?¨Ïóê???¨Ïö©?òÎäî ?êÏù¥?îÍ? nÍ∞úÏù¥Î©?SetPipelineStateÍ∞Ä nÎ≤??∏Ï∂ú?úÎã§
...
void BaseScene::AddObject(Object* object)
{
	...
	//TODO: ∫Æ√º≈©∞° « ø‰«— ø¿∫Í¡ß∆Æ¥¬ µ˚∑Œ ∏ÆΩ∫∆Æ∏¶ ª˝º∫ »ƒ ø©±‚ø° √ﬂ∞°
}
...
void BaseScene::CheckObjectIsGround(Object* object)
{
	...
	if (is_collide)
	{
		float distance_on_ground = distance - kGroundYOffset; //ÏßÄÎ©¥ÍπåÏßÄ??Í±∞Î¶¨
